...
window.addEventListener('DOMContentLoaded', (event) => {
        ...
        frame.contentWindow.document.getElementById('closeButton').addEventListener('click', () => {
...
function updateMarkers(wells, zoom) {
    ...
    wells.forEach(well => {
        if (well.Cordenadas) {
            ...
            marker.bindPopup('<b>Código:</b> ' + well.Codigo + '<br><b>Localidade:</b> ' + well.Localidade + '<br><a href="/' + system + '/DetalhesPoco/' + well.Codigo + '" target="_blank">Ver detalhes do poço</a>');
